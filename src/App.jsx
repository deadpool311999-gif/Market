...
export default function App() {
  ...
  const [values, setValues] = useState(() =>
    mergeValues(saved && saved.catalog ? saved.catalog : initialCatalog, saved ? saved.values : null),
  );
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Set quantities from 0 to 20. If quantity is 0, the item stays out. If quantity is above 0, it is included
                  automatically.
                </p>
              </div>
